...
<div class="container">
    ...
    <form class="form-signin" role="form">
        ...
        <?php endif; ?>
        <a href="https://github.com/puneetkay/Facebook-PHP-CodeIgniter" class="btn btn-lg btn-success btn-block"
           target="_blank" role="button">View Source on Github</a>

        <div class="footer">
            <p>With <i class="fa fa-heart"></i> by <a href='http://puneetk.com/' target="_blank" title="Puneet Kalra">Puneet
                    Kalra</a>.</p>
        </div>
    </form>
    ...
    <div class="text-center">
        <div style="margin-top: 30px;">
            <iframe
                src="http://ghbtns.com/github-btn.html?user=puneetkay&repo=Facebook-PHP-CodeIgniter&type=watch&count=true"
                allowtransparency="true" frameborder="0" scrolling="0" width="110" height="20"></iframe>
            <a href="https://twitter.com/share" class="twitter-share-button"
               data-url="http://puneetk.com/facebook-php-codeigniter/" data-via="puneetkay">Tweet</a>
