                    ...
                    <div class="panel">
                        ...
                        <div class="panel-footer">
                            ...
                            <?php if ($loansToMe[$i]->due_date == null) { ?>
                                <form action="/page/deleteLoan" method="post"
                                      name="cancelRequestFormNum<?php echo $i; ?>">
                                    <input type="hidden" value="<?php echo $loansToMe[$i]->google_id ?>"
                                           name="bookGoogleId">
                                    <input type="hidden" value="<?php echo $loansToMe[$i]->friendId ?>"
                            ...
                            <?php } else { ?>
                                <form action="/page/deleteLoan" method="post"
                                      name="completeLoanFormNum<?php echo $i ?>">
                                    <input type="hidden" value="<?php echo $loansToMe[$i]->google_id ?>"
                                           name="bookGoogleId">
                                    <input type="hidden" value="<?php echo $loansToMe[$i]->friendId ?>"
                                           name="RequestingFriendId">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-footer">
                            ...
                            <?php if ($loansFromMe[$i]->due_date == null) { ?>
                                <form action="/page/confirmLoan" method="post"
                                      name="confirmLoanFormNum<?php echo $i ?>">
                                    <input type="hidden" value="<?php echo $loansFromMe[$i]->google_id ?>"
                                           name="bookGoogleId">
                            ...
                            <?php } else { ?>
                                <form action="/page/deleteLoan" method="post"
                                      name="markReturnedFormNum<?php echo $i ?>">
                                    <input type="hidden" value="<?php echo $loansFromMe[$i]->google_id ?>"
                                           name="bookGoogleId">
                                    <input type="hidden" value="<?php echo $loansFromMe[$i]->userId ?>"
                                           name="RequestingFriendId">
